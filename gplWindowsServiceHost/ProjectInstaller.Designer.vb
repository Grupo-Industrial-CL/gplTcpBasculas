<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller1
        '
        Me.ServiceInstaller1.Description = "Lanza el Servicio Host WFC para consumir por medio de TCP las funciones de consul" &
    "ta y comando de Basculas"
        Me.ServiceInstaller1.DisplayName = "BasculasHOST"
        Me.ServiceInstaller1.ServiceName = "BasculasHOST"
        '
        'ProjectInstaller
        '
